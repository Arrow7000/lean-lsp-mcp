...
- **lean_references**: Find all references to a symbol at position (including declaration).
- **lean_rename**: Rename a symbol project-wide via LSP. Applies edits to files on disk.
